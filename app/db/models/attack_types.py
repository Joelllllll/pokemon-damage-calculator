class AttackType:
  ...
  @classmethod
  def weak_to(cls, attack_type) -> bool:
    return attack_type in cls.weakness()

  @classmethod
  def strong_against(cls, attack_type) -> bool:
    return attack_type in cls.strength()

  @classmethod
  def immune_to(cls, attack_type) -> bool:
    return attack_type in cls.immune()

  @classmethod
  def resists(cls, attack_type) -> bool:
...
class Steel(AttackType):
  ...
  @classmethod
  def resistances(cls):
    return [Bug, Dragon, Flying, Grass, Ice, Psychic, Rock, Steel]
